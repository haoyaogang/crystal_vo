...
if [ "$FF_ARCH" = "armv7a" ]; then
    ...
    FF_BUILD_NAME_X264=x264-arm64-v8a
    FF_SOURCE=$FF_BUILD_ROOT/$FF_BUILD_NAME
...
FF_DEP_X264_PKG=$FF_BUILD_ROOT/build/$FF_BUILD_NAME_X264/output/lib/pkgconfig
mkdir -p $FF_PREFIX
mkdir -p $FF_SYSROOT
...
#cp $FF_DEP_X264_PKG/*.pc $FF_PREFIX/shared/lib/pkgconfig
for f in $FF_PREFIX/lib/pkgconfig/*.pc; do
    ...
    #Amysedi $f 's/-lx264/-lijkffmpeg/g'
done
